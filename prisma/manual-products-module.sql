-- Module sản phẩm CRM (chạy trên Supabase SQL Editor hoặc psql)
-- Cần có trước khi import từ Sapo → bảng products.
...
VALUES ('MAIN', 'Chi nhánh chính')
ON CONFLICT (code) DO NOTHING;

INSERT INTO warehouses (code, name, branch_id)
SELECT 'MAIN-WH', 'Kho chính', b.id
FROM branches b
WHERE b.code = 'MAIN'
ON CONFLICT (code) DO NOTHING;
